import{O as c,C as e}from"./bsConstants-BSyV9W6M.js";/* empty css                   */c.onReady(async()=>{const d=window.location.search,t=new URLSearchParams(d),a=decodeURIComponent(t.get("sender")),r=decodeURIComponent(t.get("message")),s=decodeURIComponent(t.get("color")),i=decodeURIComponent(t.get("queue"));e.BONESNOTIFICATIONS.innerHTML=`
